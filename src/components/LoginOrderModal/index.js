...
class LoginOrderModal extends Component {
    state = {};
            ...
            <Fragment>
                {!isLoggedIn && loginBtnLocation && (
                    <Wrapper>
                        ...
                        <Title>
                            <FormattedMessage
                                id="modal.login_order.label_login"
                        ...
                        <Tooltip
                            ...
                            html={(
                                <div style={{ maxWidth: 250, textAlign: 'center' }}>
                                    <FormattedMessage
                                        id="modal.login_order.label_login_with_telegram"
                                        defaultMessage="Please log in with telegram so we can process your order!"
                                    />
                                </div>
                            )}
                        >
