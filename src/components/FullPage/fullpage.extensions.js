...
!function (e, t, n, o, r) {
    ...
    'use strict';
    var Qt = 'fullpage-wrapper', Jt = '.' + Qt, Kt = 'fp-responsive', $t = 'fp-notransition', qt = 'fp-destroyed', en = 'fp-enabled', tn = 'fp-viewing', nn = 'active', on = '.' + nn, rn = 'fp-completely', ln = 'fp-section', an = '.' + ln, sn = an + on, cn = 'fp-tableCell', un = '.' + cn, dn = 'fp-auto-height', fn = 'fp-normal-scroll', vn = 'fp-nav', pn = '#' + vn, hn = 'fp-tooltip', gn = 'fp-slide', mn = '.' + gn, Sn = mn + on, bn = 'fp-slides', yn = '.' + bn, wn = 'fp-slidesContainer', En = '.' + wn, xn = 'fp-table', An = 'fp-slidesNav', Ln = '.' + An, Mn = Ln + ' a', e = 'fp-controlArrow', Tn = '.' + e, On = 'fp-prev', kn = Tn + '.fp-prev', Cn = Tn + '.fp-next';
    ...
    function In(e) {
        ...
        for (var t = 1, n = arguments.length; t < n; ++t) {
            var o = arguments[t];
            if (o) for (var r in o) o.hasOwnProperty(r) && ('[object Object]' !== Object.prototype.toString.call(o[r]) ? e[r] = o[r] : e[r] = In(e[r], o[r]));
        }
        return e;
    }
    ...
    return Ut.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
        ...
        $: Rn, deepExtend: In, hasClass: zn, getWindowHeight: Bn, css: Nn, until: n, prevUntil: jn, nextUntil: Pn, prev: Wn, next: Yn, last: Dn, index: Xn, getList: l, hide: Vn, show: Zn, isArrayOrList: i, addClass: Gn, removeClass: Fn, appendTo: Un, wrap: o, wrapAll: _n, wrapInner: Qn, unwrap: Jn, closest: Kn, after: $n, before: qn, insertBefore: r, getScrollTop: eo, siblings: to, preventDefault: no, isFunction: oo, trigger: ro, matches: io, toggle: lo, createElementFromHTML: ao, remove: so, filter: function (e, t) {
            Array.prototype.filter.call(e, t);
        }, untilAll: a, nextAll: co, prevAll: uo, showError: Hn, prependTo: fo, toggleClass: function (e, t, n) {
        ...
        if (!zn(Rn('html'), en)) {
            var r = Rn('html, body'), m = Rn('body')[0], S = {};
            g = In({
                ...
                controlArrowColor: '#fff', verticalCentered: !0, sectionsColor: [], paddingTop: 0, paddingBottom: 0, fixedElements: null, responsive: 0, responsiveWidth: 0, responsiveHeight: 0, responsiveSlides: !1, parallax: !1, parallaxOptions: { type: 'reveal', percentage: 62, property: 'translate' }, cards: !1, cardsOptions: { perspective: 100, fadeContent: !0, fadeBackground: !0 }, sectionSelector: '.section', slideSelector: '.slide', v2compatible: !1, afterLoad: null, onLeave: null, afterRender: null, afterResize: null, afterReBuild: null, afterSlideLoad: null, onSlideLeave: null, afterResponsive: null, lazyLoading: !0
            }, g);
            var b, l, c, n, a = !1, o = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), i = 'ontouchstart' in Ut || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, y = 'string' == typeof e ? Rn(e)[0] : e, w = Bn(), E = !1, s = !0, x = !0, u = [], d = { m: { up: !0, down: !0, left: !0, right: !0 } };
            d.k = In({}, d.m);
            var f, v, p, h, A, L, M, T, O = kt(), k = { touchmove: 'ontouchmove' in Ut ? 'touchmove' : O.move, touchstart: 'ontouchstart' in Ut ? 'touchstart' : O.down }, C = !1, H = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]', R = !1;
            try {
            ...
            Dt(), Ut.fp_easings = In(Ut.fp_easings, {
                ...
                ro(y, 'destroy', e), K(!1, 'internal'), ne(!0), oe(!1), re(!1), Gn(y, qt), clearTimeout(h), clearTimeout(p), clearTimeout(v), clearTimeout(A), clearTimeout(L), Ut.removeEventListener('scroll', Ee), Ut.removeEventListener('hashchange', qe), Ut.removeEventListener('resize', ft), _t.removeEventListener('keydown', tt), _t.removeEventListener('keyup', nt), ['click', 'touchstart'].forEach(function (e) {
                    ...
                    Ye(e, 'srcset');
                }), so(Rn(pn + ', ' + Ln + ', ' + Tn)), Nn(Rn(an), { height: '', 'background-color': '', padding: '' }), Nn(Rn(mn), { width: '' }), Nn(y, { height: '', position: '', '-ms-touch-action': '', 'touch-action': '' }), Nn(r, { overflow: '', height: '' }), Fn(Rn('html'), en), Fn(m, Kt), m.className.split(/\s+/).forEach(function (e) {
            ...
            }, S.shared = { afterRenderActions: we }, Ut.fullpage_api = S, g.$ && (g.$.fn.fullpage = S), ge('continuousHorizontal'), ge('scrollHorizontally'), ge('resetSliders'), ge('interlockedSlides'), ge('responsiveSlides'), ge('fadingEffect'), ge('dragAndMove'), ge('offsetSections'), ge('scrollOverflowReset'), ge('parallax'), ge('cards'), Nt('dragAndMove') && S.dragAndMove.init(), g.css3 && (g.css3 = function () {
                var e, t = _t.createElement('p'), n = { webkitTransform: '-webkit-transform', OTransform: '-o-transform', msTransform: '-ms-transform', MozTransform: '-moz-transform', transform: 'transform' };
                ...
                if (!g.anchors.length) {
                    var e = '[data-anchor]', t = Rn(g.sectionSelector.split(',').join(e + ',') + e, y);
                    t.length && (N = !0, t.forEach(function (e) {
                        g.anchors.push(e.getAttribute('data-anchor').toString());
                    }));
                }
                if (!g.navigationTooltips.length) {
                    var e = '[data-tooltip]', n = Rn(g.sectionSelector.split(',').join(e + ',') + e, y);
                    n.length && n.forEach(function (e) {
                        g.navigationTooltips.push(e.getAttribute('data-tooltip').toString());
                    });
                }
            }(), function () {
                Nn(y, { height: '100%', position: 'relative' }), Gn(y, Qt), Gn(Rn('html'), en), w = Bn(), Fn(y, qt), Gn(Rn(g.sectionSelector, y), ln), Gn(Rn(g.slideSelector, y), gn), jt('parallax', 'init');
                for (var e = Rn(an), t = 0; t < e.length; t++) {
                    var n = t, o = e[t], r = Rn(mn, o), i = r.length;
                ...
                g.fixedElements && g.css3 && Rn(g.fixedElements).forEach(function (e) {
                    ...
                    Rn('ul', n)[0].innerHTML = o, Nn(Rn(pn), { 'margin-top': '-' + Rn(pn)[0].offsetHeight / 2 + 'px' }), Gn(Rn('a', Rn('li', Rn(pn)[0])[Xn(Rn(sn)[0], an)]), nn);
        ...
        function K(e, t) {
            ...
            var n = Rn(sn)[0];
            if (g.autoScrolling && !g.scrollBar) Nn(r, { overflow: 'hidden', height: '100%' }), $(B.recordHistory, 'internal'), Nn(y, { '-ms-touch-action': 'none', 'touch-action': 'none' }), null != n && Rt(n.offsetTop); else if (Nn(r, { overflow: 'visible', height: 'initial' }), $(!!g.autoScrolling && B.recordHistory, 'internal'), Nn(y, { '-ms-touch-action': '', 'touch-action': '' }), Bt(y), null != n) {
        ...
        function te(e) {
            e ? (function () {
                ...
                var n = 'onwheel' in _t.createElement('div') ? 'wheel' : void 0 !== _t.onmousewheel ? 'mousewheel' : 'DOMMouseScroll', o = !!R && { passive: !1 };
        ...
        function oe(e) {
            e ? (te(!0), function () {
                if (o || i) {
                    g.autoScrolling && (m.removeEventListener(k.touchmove, Le, { passive: !1 }), m.addEventListener(k.touchmove, Le, { passive: !1 }));
                    var e = g.touchWrapper;
                    e.removeEventListener(k.touchstart, Oe), e.removeEventListener(k.touchmove, Me, { passive: !1 }), e.addEventListener(k.touchstart, Oe), e.addEventListener(k.touchmove, Me, { passive: !1 });
                }
            }()) : (te(!1), function () {
                if (o || i) {
                    g.autoScrolling && (m.removeEventListener(k.touchmove, Me, { passive: !1 }), m.removeEventListener(k.touchmove, Le, { passive: !1 }));
                    var e = g.touchWrapper;
        ...
        function de(e) {
            if (!zn(y, qt)) {
                ...
                for (var t = Rn(an), n = 0; n < t.length; ++n) {
                    var o = t[n], r = Rn(yn, o)[0], i = Rn(mn, o);
        ...
        function ve(e) {
            ...
            t && Kn(t, pn + ' a') ? function (e) {
                ...
                no(e);
                var t = Rn(yn, Kn(this, an))[0], n = Rn(mn, t)[Xn(Kn(this, 'li'))];
                st(t, n);
        ...
        function me(e, t, n) {
            ...
            s.className = wn, _n(t, s), Nn(Rn(En, e), { width: o + '%' }), 1 < n && (g.controlArrows && (l = e, a = [ao('<div class="fp-controlArrow fp-prev"></div>'), ao('<div class="fp-controlArrow fp-next"></div>')], $n(Rn(yn, l)[0], a), '#fff' !== g.controlArrowColor && (Nn(Rn(Cn, l), { 'border-color': 'transparent transparent transparent ' + g.controlArrowColor }), Nn(Rn(kn, l), { 'border-color': 'transparent ' + g.controlArrowColor + ' transparent transparent' })), g.loopHorizontal || Vn(Rn(kn, l))), g.slidesNavigation && function (e, t) {
                ...
                Nn(n, { 'margin-left': '-' + n.innerWidth / 2 + 'px' }), Gn(Rn('a', Rn('li', n)[0]), nn);
        ...
        function be(e, t) {
            t || null != Rn(sn)[0] || Gn(e, nn), n = Rn(sn)[0], Nn(e, { height: Se(e) + 'px' }), g.paddingTop && Nn(e, { 'padding-top': g.paddingTop }), g.paddingBottom && Nn(e, { 'padding-bottom': g.paddingBottom }), void 0 !== g.sectionsColor[t] && Nn(e, { 'background-color': g.sectionsColor[t] }), void 0 !== g.anchors[t] && e.setAttribute('data-anchor', g.anchors[t]);
        }
        ...
        function Ee() {
            ...
            if (ro(y, 'onScroll'), (!g.autoScrolling || g.scrollBar || Nt('dragAndMove')) && !Wt()) {
                var t = Nt('dragAndMove') ? Math.abs(S.dragAndMove.getCurrentScroll()) : eo(), n = 0, o = t + Bn() / 2, r = (Nt('dragAndMove') ? S.dragAndMove.getDocumentHeight() : m.offsetHeight - Bn()) === t, i = Rn(an);
                if (r) n = i.length - 1; else if (t) for (var l = 0; l < i.length; ++l) i[l].offsetTop <= o && (n = l); else n = 0;
                if (!zn(e = i[n], nn)) {
                    X = !0;
                    var a, s, c = Rn(sn)[0], u = Xn(c, an) + 1, d = mt(e), f = e.getAttribute('data-anchor'), v = Xn(e, an) + 1, p = Rn(Sn, e)[0], h = { activeSection: c, sectionIndex: v - 1, anchorLink: f, element: e, leavingSection: u, direction: d };
                    p && (s = p.getAttribute('data-anchor'), a = Xn(p)), x && (Gn(e, nn), Fn(to(e), nn), jt('parallax', 'afterLoad'), oo(g.onLeave) && Be('onLeave', h), oo(g.afterLoad) && Be('afterLoad', h), g.resetSliders && S.resetSliders && S.resetSliders.apply({ localIsResizing: E, leavingSection: u }), Ze(c), De(e), Xe(e), gt(f, v - 1), g.anchors.length && (b = f), Lt(a, s, f)), clearTimeout(A), A = setTimeout(function () {
                        X = !1;
                    }, 100);
                }
        ...
        function Ae(e) {
            if (d.m[e]) {
                ...
                if (S.scrollHorizontally && (t = S.scrollHorizontally.getScrollSection(e, t)), g.scrollOverflow) {
                    var n = g.scrollOverflowHandler.scrollable(Rn(sn)[0]), o = 'down' === e ? 'bottom' : 'top';
                    if (null != n) {
        ...
        function Ce(e) {
            var t = (new Date).getTime(), n = zn(Rn('.fp-completely')[0], fn);
            if (!d.m.down && !d.m.up) return no(e), !1;
            if (g.autoScrolling && !c && !n) {
                var o = (e = e || Ut.event).wheelDelta || -e.deltaY || -e.detail, r = Math.max(-1, Math.min(1, o)), i = void 0 !== e.wheelDeltaX || void 0 !== e.deltaX, l = Math.abs(e.wheelDeltaX) < Math.abs(e.wheelDelta) || Math.abs(e.deltaX) < Math.abs(e.deltaY) || !i;
        ...
        function He(e, t) {
            var n = null == t ? Rn(sn)[0] : t, o = Rn(yn, n)[0];
            if (!(null == o || Pt() || a || Rn(mn, o).length < 2)) {
                var r = Rn(Sn, o)[0], i = null;
        ...
        function Ie(e) {
            var t = e.offsetHeight, n = e.offsetTop, o = n, r = Nt('dragAndMove') && S.dragAndMove.isGrabbing ? S.dragAndMove.isScrollingDown() : _ < n, i = o - w + t, l = g.bigSectionsDestination;
        ...
        function ze(e, t, n) {
            if (null != e) {
                var o, r, i = { element: e, callback: t, isMovementUp: n, dtop: Ie(e), yMovement: mt(e), anchorLink: e.getAttribute('data-anchor'), sectionIndex: Xn(e, an), activeSlide: Rn(Sn, e)[0], activeSection: Rn(sn)[0], leavingSection: Xn(Rn(sn), an) + 1, localIsResizing: E };
        ...
        function Be(e, t) {
            var n, o, r, i, l = (o = e, r = t, (i = g.v2compatible ? {
                ...
                afterRender: function () {
                    return { section: Ne(Rn(sn)[0]), slide: je(Rn(Sn, Rn(sn)[0])[0]) };
                }, onLeave: function () {
                    return { origin: Ne(r.activeSection), destination: Ne(r.element), direction: r.direction };
                }, afterLoad: function () {
                    return i.onLeave();
                }, afterSlideLoad: function () {
                    return { section: Ne(r.section), origin: je(r.prevSlide), destination: je(r.destiny), direction: r.direction };
                }, onSlideLeave: function () {
        ...
        function Ue(e) {
            var t = function () {
                ...
                return '';
            }(), n = ['MTM0bG9jYWxob3N0MjM0', 'MTM0MC4xMjM0', 'MTM0anNoZWxsLm5ldDIzNA==', 'UDdDQU5ZNlNN'], o = Fe(n[0]), r = Fe(n[1]), i = Fe(n[2]), l = Fe(n[3]), a = [o, r, i].indexOf(t) < 0 && 0 !== t.length, s = void 0 !== P[e] && P[e].length;
            if (!s && a) return !1;
            var c = s ? Fe(P[e]) : '', u = 1 < (c = c.split('_')).length && -1 < c[1].indexOf(e, c[1].length - e.length);
        ...
        function $e() {
            var e = et(), t = e.section, n = e.slide;
            t && (g.animateAnchor ? xt(t, n) : ae(t, n));
        }

        function qe() {
            if (!X && !g.lockAnchors) {
                var e = et(), t = e.section, n = e.slide, o = void 0 === b, r = void 0 === b && void 0 === n && !a;
                if (t && t.length) {
        ...
        function tt(e) {
            clearTimeout(M);
            var t = _t.activeElement, n = e.keyCode;
            9 === n ? function (e) {
        ...
        function st(e, t, n) {
            var o = Kn(e, an), r = { slides: e, destiny: t, direction: n, destinyPos: { left: t.offsetLeft }, slideIndex: Xn(t), section: o, sectionIndex: Xn(o, an), anchorLink: o.getAttribute('data-anchor'), slidesNav: Rn(Ln, o)[0], slideAnchor: Tt(t), prevSlide: Rn(Sn, o)[0], prevSlideIndex: Xn(Rn(Sn, o)[0]), localIsResizing: E };
        ...
        function vt() {
            var e = g.responsive || g.responsiveWidth, t = g.responsiveHeight, n = e && Ut.innerWidth < e, o = t && Ut.innerHeight < t;
        ...
        function Mt(e) {
            if (g.recordHistory) location.hash = e; else if (o || i) Ut.history.replaceState(void 0, void 0, '#' + e); else {
        ...
        function Tt(e) {
            if (!e) return null;
            var t = e.getAttribute('data-anchor'), n = Xn(e);
            return null == t && (t = n), t;
        }

        function Ot() {
            var e = Rn(sn)[0], t = Rn(Sn, e)[0], n = Tt(e), o = Tt(t), r = String(n);
        ...
        function kt() {
            return Ut.PointerEvent ? { down: 'pointerdown', move: 'pointermove' } : { down: 'MSPointerDown', move: 'MSPointerMove' };
        }
        ...
        function Rt(e) {
            var t = Math.round(e);
            if (g.css3 && g.autoScrolling && !g.scrollBar) wt('translate3d(0px, -' + t + 'px, 0px)', !1); else if (g.autoScrolling && !g.scrollBar) Nn(y, { top: -t + 'px' }), S.test.top = -t + 'px'; else {
                var n = Pe(t);
        ...
        function Dt() {
            t || (Hn('error', 'Fullpage.js version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:'), Hn('error', 'https://github.com/alvarotrigo/fullPage.js#options.')), zn(Rn('html'), en) ? Hn('error', 'Fullpage.js can only be initialized once and you are doing it multiple times!') : (g.continuousVertical && (g.loopTop || g.loopBottom) && (g.continuousVertical = !1, Hn('warn', 'Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled')), !g.scrollOverflow || !g.scrollBar && g.autoScrolling || Hn('warn', 'Options scrollBar:true and autoScrolling:false are mutually exclusive with scrollOverflow:true. Sections with scrollOverflow might not work well in Firefox'), !g.continuousVertical || !g.scrollBar && g.autoScrolling || (g.continuousVertical = !1, Hn('warn',
