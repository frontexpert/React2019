...
export const QRCodePartial = styled.div.attrs({ className: 'center-wrapper__qr-code-partial' })`
    ...
    &.size-100 {
        margin-top: ${props => props.height ? (-props.height * .15 + 'px') : '0px'};
    }
`;
...
export const PhoneNumberPartial = styled.div`
    ...
    @keyframes enter-phone-number-wrapper-animation-2 {
        0% {
            padding: 0 9px;
            width: 64px;
            height: 64px;
    ...
    @keyframes enter-code-wrapper-animation-2 {
        0% {
            padding: 0 9px 0 20px;
            width: calc(100% - 50px);
            height: 64px;
    ...
    &.enter-phone-number {
        animation-name: enter-phone-number-wrapper-animation-2;
        animation-duration: .5s;
        animation-delay: .5s;
        animation-fill-mode: both;
    }
    ...
    &.enter-code {
        animation-name: enter-code-wrapper-animation-2;
        animation-duration: .5s;
        animation-fill-mode: both;
...
export const InputWrapper = styled.div`
    ...
    @keyframes enter-code-input-animation-2 {
        0% {
            height: 0;
        }
    ...
    &.code-input {
        ...
        &.enter-code {
            animation-name: enter-code-input-animation-2;
            animation-duration: .5s;
            animation-fill-mode: both;
        }
    }
