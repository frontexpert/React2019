...
const dropAnim = (height) => keyframes`
    0% { margin-top: -${height * 2}px; }
    10% { margin-top: 0; }
    100% { margin-top: 0; }
`;

const slideLeftAnim = keyframes`
    0% { margin-left: 100%; }
    10% { margin-left: 100%; }
    20% { margin-left: 0; }
    100% { margin-left: 0; }
...
export const Row = styled.div`
    position: relative;
    height: ${props => props.height}px;
    margin-bottom: ${props => props.isBuy ? '10px' : ''};
    // padding-right: ${props => props.length > 4 ? '15px' : 0};
    display: flex;
    // background: ${props => props.progress && props.isTrading && `linear-gradient(90deg, ${props.isArrowBuy ? '#0000' : props.theme.palette.btnNegativeBg} ${props.isArrowBuy ? 100 - props.progress : props.progress}%, ${props.isArrowBuy ? props.theme.palette.btnPositiveBg : '#0000'} ${props.isArrowBuy ? 100 - props.progress : props.progress}%);`};
    border: 1px solid ${props => props.theme.palette.orderHistoryInnerBorder};
    ...
    ${props => props.isOrderStarted && props.index === 2 && `
        animation: ${dropAnim(props.height)} 10s linear;
        margin-top: 0;
    `}
    ...
    ${props => props.isNumberFilled && props.index < 2 && `
        animation: ${slideLeftAnim} 10s linear;
        margin-left: 0;
    `}
    
    &:hover {
        background-color: ${props => props.isArrowBuy ? props.theme.palette.btnPositiveBg : props.theme.palette.btnNegativeBg};
...
export const InfoHistory = styled.div.attrs({ className: 'history-info-wrapper' })`
    ...
    .info-arrow-directional {
        ...
        .wrapper_arrow {
            ...
            align-items: center;     
            .arrow-icon {
                fill: ${props => props.progress ? props.theme.palette.clrHighContrast : props.isArrowBuy ? props.theme.palette.btnPositiveBg : props.theme.palette.btnNegativeBg};    //set arrow icon fill color
