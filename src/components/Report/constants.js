...
].map((count) => `${count} rows per page`);

export const makerTakerList = [
    'All',
    'Maker',
    'Taker'
];
...
export const typeList = [
    ...
    'Bank',
    'Cryptocurrency',
    'Other Globitex client account',
    'Own Globitex account'
];
...
export const tradeHistoryDropdowns = [
    'instrument',
    'account',
    'side',
    'makerTaker',
...
export const paymentHistoryDropdowns = [
    'account',
    'status',
    'type',
    'direction'
...
export const navReportDropdowns = [
    'reportType',
    'account',
    'outputType'
];