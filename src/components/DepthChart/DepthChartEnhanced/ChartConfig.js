...
export const initConfiguration = (baseCur, quoteCur, midMarket, buy, sell, theme, height, width, spread, setTooltipColorMode) => {
    let rightSpace = 0;
    ...
    return (
        {
            ...
            tooltip: {
                ...
                formatter() {
                    ...
                    let tooltipTop = this.point.plotY;

                    let margin = '';
                    if (this.point.plotX < 76) {
                        margin += ' margin-left: -' + this.point.plotX + 'px;';
                        margin += ' margin-right: ' + this.point.plotX + 'px;';
                    } else if (this.point.plotX + 70 > width - rightSpace) {
                        let offset = this.point.plotX + 70 - width + rightSpace;
                        margin += 'margin-left: calc(-50% - ' + offset + 'px);';
                        margin += 'margin-right: calc(50% + ' + offset + 'px);';
                    }
                    ...
                    if (this.series.name === 'Bids') {
                        ...
                        tooltipHtml = `
                        <div class="tooltip-wrapper" style="top: ` + tooltipTop + `px">
