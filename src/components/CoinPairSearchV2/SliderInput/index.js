...
const SliderTrackProgress = styled.div`
    ...
    height: 2px;
    background: ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : props.theme.palette.ctrlSliderTrackProgressBg};
    z-index: 2;
`;
...
const SliderTrackCurrentValue = styled.div`
    ...
    margin: 0;
    padding: 0;
    background: ${props => props.isDisabledColors ? props.theme.palette.clrBackground : props.theme.palette.ctrlSliderTrackCurrentBg};
    border: 1px solid ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : props.theme.palette.ctrlSliderTrackProgressBg};
    border-radius: 3px;
    font-size: 11px;
    line-height: 14px;
    color: ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : props.theme.palette.ctrlSliderTrackProgressBg};
    text-align: center;
    ...
    &:after {
        ...
        border-style: solid;
        border-width: 4px;
        border-color: transparent ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : props.theme.palette.ctrlSliderTrackProgressBg} transparent transparent;
    }
    ...
    &:after {
        ...
        border-color: transparent transparent transparent ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : props.theme.palette.ctrlSliderTrackProgressBg};
    }
`;
...
const Delimeter = styled.div`
    ...
    height: 4px;
    border-radius: 50%;
    background: ${props => props.isDisabledColors ? props.theme.palette.ctrlsliderTrackDisabledBg : (props.position <= props.progress ? props.theme.palette.ctrlSliderDelimiterActiveBg : props.theme.palette.ctrlSliderDelimiterBg)};
...
class SliderInput extends Component {
    constructor(props) {
        ...
        this.updateExecPlan = _.debounce(() => {
            const {
                lowestExchangeStore,
            } = this.props;

            lowestExchangeStore.getExecPlan();
        }, 1000);
    }
