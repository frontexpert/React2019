...
const primaryActive = '#004981'; // '#2c537b';
const light = '#fff';
...
const btnColorPalette = {
    ...
    btnPositiveBg: '#01B067',
    btnPositiveText: '#fff',
    btnPositiveHoverBg: '#05db75',
...
export const darkTheme = {
    ...
    [rootKeys.palette]: {
        ...
        */
        ...
        orderBookHeaderBg: corePalette.clrBackground,
        orderBookHeaderBorder: corePalette.clrBorder,
        ...
        orderFormInputBg: corePalette.clrMainWindow,
        ...
        coinPairDropDownItemText: corePalette.clrPurple,
        coinPairDropDownItemText2: corePalette.clrPurple,
        coinPairDropDownItemHoverBg: corePalette.clrMainWindow,
        coinPairDropDownItemHoverText: corePalette.clrHighContrast,
        coinPairDropDownItemHoverText2: corePalette.clrHighContrast,
        ...
        gradientBtnCloseBg: 'linear-gradient(to right, rgba(205,36,36,1) 0%, rgba(205,36,36,1) 15%, rgba(255,31,31,1) 45%, rgba(255,31,31,1) 55%, rgba(205,36,36,1) 85%, rgba(205,36,36,1) 100%)',
        gradientBtnCloseHoverBg: 'linear-gradient(to right, rgba(205,36,36,1) 0%, rgba(255,31,31,1) 15%, rgba(255,31,31,1) 45%, rgba(255,31,31,1) 55%, rgba(255,31,31,1) 85%, rgba(205,36,36,1) 100%)',
